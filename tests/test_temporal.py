...
class TestTemporalValidityBasic:
    ...
    def test_create_with_valid_from(self) -> None:
    ...
    def test_create_with_valid_until(self) -> None:
...
class TestTemporalValidityIsValidAt:
    ...
    def test_always_valid_is_valid_anytime(self) -> None:
    ...
    def test_range_before_start(self) -> None:
    ...
    def test_range_after_end(self) -> None:
...
class TestTemporalValidityIsCurrent:
    ...
    def test_always_valid_is_current(self) -> None:
        """Always valid should be current."""
        tv = TemporalValidity.always_valid()
        assert tv.is_current() is True

    def test_from_now_is_current(self) -> None:
        """from_now() should be current."""
        tv = TemporalValidity.from_now()
        assert tv.is_current() is True

    def test_future_validity_not_current(self) -> None:
        """Future validity should not be current."""
        future = datetime.now() + timedelta(days=30)
        tv = TemporalValidity(valid_from=future)
        assert tv.is_current() is False

    def test_expired_not_current(self) -> None:
...
class TestTemporalValidityOverlaps:
    ...
    def test_always_valid_overlaps_all(self) -> None:
    ...
    def test_two_always_valid_overlap(self) -> None:
...
class TestTemporalValidityContains:
    ...
    def test_contains_delegates_to_is_valid_at(self) -> None:
...
class TestTemporalValidityRemaining:
    ...
    def test_remaining_no_end_is_none(self) -> None:
        """No valid_until should return None remaining."""
        tv = TemporalValidity(valid_from=datetime.now())
        assert tv.remaining() is None

    def test_remaining_future_end(self) -> None:
    ...
    def test_remaining_past_end_is_zero(self) -> None:
...
class TestTemporalValidityExpireNow:
    ...
    def test_expire_now_sets_valid_until(self) -> None:
    ...
    def test_expire_now_returns_new_instance(self) -> None:
    ...
    def test_expire_now_preserves_valid_from(self) -> None:
...
class TestTemporalValidityExtend:
    ...
    def test_extend_adds_duration(self) -> None:
...
class TestTemporalValidityToDict:
    ...
    def test_to_dict_always_valid(self) -> None:
...
class TestTemporalValidityFromDict:
    ...
    def test_from_dict_with_strings(self) -> None:
...
class TestTemporalValidityStr:
    ...
    def test_str_always_valid(self) -> None:
        """__str__() for always valid."""
        tv = TemporalValidity.always_valid()
        assert str(tv) == "always valid"

    def test_str_valid_from_only(self) -> None:
    ...
    def test_str_valid_until_only(self) -> None:
...
class TestSupersessionChain:
    ...
    def test_original_id(self) -> None:
    ...
    def test_single_belief_chain(self) -> None:
...
class TestSupersessionChainGetAtTime:
    ...
    def test_get_at_time_before_first(self) -> None:
    ...
    def test_get_at_time_at_first(self) -> None:
    ...
    def test_get_at_time_between(self) -> None:
    ...
    def test_get_at_time_after_last(self) -> None:
...
class TestCalculateFreshness:
    ...
    def test_brand_new_is_fresh(self) -> None:
...
class TestFreshnessLabel:
    ...
    def test_freshness_label_boundaries(self, value: float, expected: str) -> None:
        """Test freshness label at various boundaries."""
        assert freshness_label(value) == expected

    def test_freshness_label_exact_boundary(self) -> None:
